...
<main class="col-lg-10 ms-sm-auto col-10 px-md-4">
    <div class="col-lg-5">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          <h1 class="h2">Edit Apotek</h1>  
        </div>
        <div class="col-lg-12">
            <form action="{{ route('update_apotek', $apotek) }}" method="POST">
                @method('patch')
                @csrf
                <div class="mb-3">
                    <input type="hidden" name="id" id="" value="{{ $apotek->id }}">
                    <label for="nama_apotek" class="form-label @error('nama_apotek') is-invalid @enderror">Nama Apotek</label>
                    <input type="text" class="form-control" id="nama_apotek" name="nama_apotek" value="{{ $apotek->nama_apotek }}">
                    @error('nama_apotek')
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="alamat_apotek" name="alamat_apotek" value="{{ $apotek->alamat_apotek }}">
                    @error('alamat_apotek')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="no_telp_apotek" name="no_telp_apotek" value="{{ $apotek->no_telp_apotek }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="obat" name="obat" value="{{ $apotek->obat }}">
                    @error('obat')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="harga" name="harga" value="{{ $apotek->harga }}">
                    @error('harga')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
